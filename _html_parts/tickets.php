                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a href="<?= base_url('tickets/' . $project_name) ?>" title="<?= $this->lang_php['go_to_tickets'] ?>">Projects</a></li>
                    ...
                    <li <?= $page_name == false || $page_name == 'dashboard' ? 'class="active"' : '' ?>><a href="<?= base_url($this->url .'/dashboard') ?>">Dashboard</a></li>
                    ...
                    <?php } ?>
                    <?php { ?>
                    <li <?= $page_name == 'task' ? 'class="active"' : '' ?>><a href="<?= base_url($this->url . '/task') ?>">Task</a></li>
                    <?php } ?>
                    <li <?= $page_name == 'activity' ? 'class="active"' : '' ?>><a href="<?= base_url($this->url . '/activity') ?>">Activity</a></li>
                </ul>
